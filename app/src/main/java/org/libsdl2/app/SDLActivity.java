...
*/
     ...
     * Derived classes may override this to adjust the compatibility policy.
     */
    ...
    /**
     * Returns whether the native SDL version is compatible with this Java layer.
     * The upstream behavior requires an exact version match.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mBrokenLibraries) {
            String expected_version = getExpectedSdlVersion();
    ...
    protected void onDestroy() {
        ...
        if (SDLActivity.mSDLThread != null) {
            ...
            try {
                // Do not block the Android main thread forever if user code ignores SDL_QUIT.
